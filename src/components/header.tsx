...
export function Header() {
  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-50">
      ...
      {isMenuOpen && (
        <div
          className="lg:hidden absolute top-full left-0 right-0 backdrop-blur-sm border-t border-white/10"
          style={{ backgroundColor: "rgba(254, 153, 0, 0.9)" }}
        >
          <div className="px-4 py-6 space-y-4">
            ...
            <button
              className="w-full text-white px-6 py-3 font-semibold transition-colors"
              style={{ backgroundColor: "#FE9900" }}
              onMouseEnter={(e) =>
